...
<div class="block">
    ...
    {* Edit button *}
    <input type="button"
           class="button epieEdit epieEditButton"
           name="epieEdit[{concat("epie/prepare/", $attribute.id, "/", $attribute.version)|ezurl(no)}]"
           id="epieEdit_{$attribute.id}_{$attribute.version}_{$attribute.contentobject_id}"
